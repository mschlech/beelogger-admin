...
export class TemperatureChartComponent implements AfterViewInit, OnDestroy, OnChanges {
  ...
  ngOnChanges(): void {
    if (this.option) {
      this.updateTemperatureChartOptions(this.temperatureChartData);
    }
  }
  ...
  updateTemperatureChartOptions(temperatureChartData: TemperatureChart) {
    const options = this.option;
    const series = this.getNewSeries(options.series, temperatureChartData.linesData);
    const xAxis = this.getNewXAxis(options.xAxis, temperatureChartData.chartLabel);
