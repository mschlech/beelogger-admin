...
@Component({
  selector: 'ngx-humidity-ball-activity',
  styleUrls: ['./humidity.component.scss'],
  template: `
    <nb-card size="medium">
      <nb-card-header>
        <span>Humidty Overview</span>
      ...
      <nb-card-body>
        <ul class="user-activity-list">
          <li *ngFor="let item of userActivity">
            ...
            <div class="humidity-percentages">
...
export class BeeBallHumidityOverviewComponent implements OnDestroy {
