...
@Component({
  selector: 'ngx-beecount-ball-activity',
  styleUrls: ['./beecount.component.scss'],
  template: `
    <nb-card size="medium">
      <nb-card-header>
        <span>Bee count overview</span>
...
export class BeecountOverviewComponent implements OnDestroy {
