...
@Component({
  selector: 'ngx-stats-bar-humidity-ball-animation-chart',
  template: `
    <div echarts
         [options]="options"
         class="echart"
...
export class StatsBarHumidityBallAnimationChartComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    this.theme.getJsTheme()
      ...
      .subscribe(config => {
        const profitBarAnimationEchart: any = config.variables.weatherBarAnimationEchart;
