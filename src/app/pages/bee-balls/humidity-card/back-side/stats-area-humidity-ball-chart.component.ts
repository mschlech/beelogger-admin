...
@Component({
  selector: 'ngx-stats-humidity-ball-ares-chart',
...
export class StatsAreaHumidityBallChartComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    this.theme.getJsTheme()
      ...
      .subscribe(config => {
        const trafficTheme: any = config.variables.humidity;
