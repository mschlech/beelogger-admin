...
@Component({
  selector: 'ngx-temperature-inside-ball-activity',
  styleUrls: ['./temperatureInside.component.scss'],
  template: `
    <nb-card size="medium">
      <nb-card-header>
        ...
        <ul class="user-activity-list">
          <li *ngFor="let item of userActivity">
            ...
            <div class="visited-pages-count">
              <div class="title">Temperature Inside</div>
              <div class="value">{{ item.pagesVisitCount }}</div>
            </div>
            <div class="temperatureInside-percentages">
...
export class BeeBallTemperatureInsideOverviewComponent implements OnDestroy {
